...
TailMeth1 <- read.csv("mLINE1_Tail_Methylation_GEE Formatted_111015.csv")
...
boxplot(Mean.Methylation ~ Exposure.Group, main = "Absolute LINE1 Methylation by Exposure Group", 
...
ANOVA.meth<-aov(Mean.Methylation~Exp1)##ANOVA
summary(ANOVA.meth) 
