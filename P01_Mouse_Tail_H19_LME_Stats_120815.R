...
TailMeth1 <- read.csv("mH19_Tail_Methylation_GEE Formatted_120715.csv")
...
TailMeth2 <- na.omit(TailMeth1[,c("Litter","id","Sex","Exposure.Group","Exposure_Coded","Age.Group","Age","Mean.Methylation","Site_2", 
                                  "Site_3","Site_4","Site_5")]) 
detach(TailMeth1)
attach(TailMeth2) 
detach(TailMeth2)
...
is.factor(TailMeth2$Exposure_Coded) ##Not a factor; can't use as one.
